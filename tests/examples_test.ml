...
let%expect_test "compile examples" =
  ...
  [%expect
    ...
    (Program
     ((bot_2 float) (checker_sum_9 float) (coord_0 (vec 2)) (coord_4 (vec 2))
      (cx_7 float) (cy_8 float) (get_uv_3 ((vec 2) -> (vec 2)))
      (is_even_10 float) (main ((vec 2) -> (vec 3))) (size_6 float)
      (top_1 (vec 2)) (u_resolution (vec 2)) (u_time float) (uv_5 (vec 2)))
     ((Extern (vec 2) u_resolution) (Extern float u_time)
      (Define get_uv_3
       (lambda (coord_0 (vec 2))
        (let top_1 (- (* 2. coord_0) u_resolution)
    ...
    (Program
     ((anf_11 (vec 2)) (anf_12 float) (anf_13 float) (anf_14 float)
      (anf_15 float) (anf_16 float) (anf_17 float) (anf_18 float) (anf_19 float)
      (anf_20 float) (anf_21 float) (anf_22 float) (anf_23 bool) (bot_2 float)
      (checker_sum_9 float) (coord_0 (vec 2)) (coord_4 (vec 2)) (cx_7 float)
      (cy_8 float) (get_uv_3 ((vec 2) -> (vec 2))) (is_even_10 float)
      (main ((vec 2) -> (vec 3))) (size_6 float) (top_1 (vec 2))
      (u_resolution (vec 2)) (u_time float) (uv_5 (vec 2)))
     ((Extern (vec 2) u_resolution) (Extern float u_time)
      (Define get_uv_3
       (return
        (lambda ((coord_0 (vec 2)))
    ...
    (Program
     ((bot_2 float) (coord_0 (vec 2)) (coord_4 (vec 2))
      (get_uv_3 ((vec 2) -> (vec 2))) (main ((vec 2) -> (vec 3)))
      (mouseUV_6 (vec 2)) (radius_7 float) (top_1 (vec 2)) (u_mouse (vec 2))
      (u_resolution (vec 2)) (u_time float) (uv_5 (vec 2)))
     ((Extern (vec 2) u_resolution) (Extern (vec 2) u_mouse)
      (Extern float u_time)
      (Define get_uv_3
    ...
    (Program
     ((anf_10 float) (anf_11 (vec 2)) (anf_12 (vec 2)) (anf_13 float)
      (anf_14 float) (anf_15 float) (anf_16 float) (anf_17 float) (anf_18 bool)
      (anf_8 (vec 2)) (anf_9 float) (bot_2 float) (coord_0 (vec 2))
      (coord_4 (vec 2)) (get_uv_3 ((vec 2) -> (vec 2)))
      (main ((vec 2) -> (vec 3))) (mouseUV_6 (vec 2)) (radius_7 float)
      (top_1 (vec 2)) (u_mouse (vec 2)) (u_resolution (vec 2)) (u_time float)
      (uv_5 (vec 2)))
     ((Extern (vec 2) u_resolution) (Extern (vec 2) u_mouse)
      (Extern float u_time)
      (Define get_uv_3
    ...
    (Program
     ((b_9 float) (bot_2 float) (coord_0 (vec 2)) (coord_4 (vec 2)) (g_8 float)
      (get_uv_3 ((vec 2) -> (vec 2))) (main ((vec 2) -> (vec 3))) (r_7 float)
      (top_1 (vec 2)) (u_resolution (vec 2)) (u_time float) (uv_5 (vec 2))
      (wave_6 float))
     ((Extern (vec 2) u_resolution) (Extern float u_time)
      (Define get_uv_3
    ...
    === anf (rainbow.glml) ===
    (Program
     ((anf_10 (vec 2)) (anf_11 float) (anf_12 float) (anf_13 float)
      (anf_14 float) (anf_15 float) (anf_16 float) (anf_17 float) (anf_18 float)
      (anf_19 float) (anf_20 float) (anf_21 float) (anf_22 float) (anf_23 float)
      (anf_24 float) (b_9 float) (bot_2 float) (coord_0 (vec 2))
      (coord_4 (vec 2)) (g_8 float) (get_uv_3 ((vec 2) -> (vec 2)))
      (main ((vec 2) -> (vec 3))) (r_7 float) (top_1 (vec 2))
      (u_resolution (vec 2)) (u_time float) (uv_5 (vec 2)) (wave_6 float))
     ((Extern (vec 2) u_resolution) (Extern float u_time)
      (Define get_uv_3
       (return
        (lambda ((coord_0 (vec 2)))
