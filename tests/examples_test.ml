  ...
  [%expect
     ...
     (((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
      ((Define (Rec 1000) mandel_4
        ((lambda (zx_5 float)
         ...
         : (float -> (float -> (float -> (float -> (float -> float)))))))
       : (float -> (float -> (float -> (float -> (float -> float))))))
      ((Define Nonrec get_uv_0_vec2_to_vec2_75
        ((lambda (coord_1 (vec 2))
          ((let top_2
            ((- ((* (2. : float) (coord_1 : (vec 2))) : (vec 2))
              (u_resolution : (vec 2)))
      ...
      ((Define Nonrec main
        ((lambda (coord_12 (vec 2))
          ((let uv_13
            ((app (get_uv_0_vec2_to_vec2_75 : ((vec 2) -> (vec 2)))
              (coord_12 : (vec 2)))
             : (vec 2))
            ((let zoom_14
              ((exp
    ...
    (Program
     (((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
      ...
      ((Define Nonrec main
        (lambda ((coord_12 (vec 2)))
         (let uv_13 (app get_uv_0_vec2_to_vec2_75 coord_12)
          (let zoom_14 (exp (+ (* (sin (* u_time 0.4)) 4.5) 3.5))
           (let cx_15 (+ -0.7453 (/ (index uv_13 0) zoom_14))
            (let cy_16 (+ 0.1127 (/ (index uv_13 1) zoom_14))
        ...
        (if (|| (> (length (vec2 zx_5 zy_6)) 2.) (> i_9 150.)) i_9
         (let next_zx_10 (+ (- (* zx_5 zx_5) (* zy_6 zy_6)) cx_7)
          (let next_zy_11 (+ (* (* 2. zx_5) zy_6) cy_8)
           (app mandel_4 next_zx_10 next_zy_11 cx_7 cy_8 (+ i_9 1.)))))))
      : (float -> (float -> (float -> (float -> (float -> float))))))
     ((Define Nonrec (name get_uv_0_vec2_to_vec2_75) (args ((coord_1 (vec 2))))
       (body
        (let top_2 (- (* 2. coord_1) u_resolution)
         (let bot_3 (min (index u_resolution 0) (index u_resolution 1))
          (/ top_2 bot_3)))))
    ...
    (Program ((Extern u_resolution) : (vec 2)) ((Extern u_time) : float)
     ((Define (Rec 1000) (name mandel_4)
       (args ((zx_5 float) (zy_6 float) (cx_7 float) (cy_8 float) (i_9 float)))
       (body
        (let anf_76 (vec2 zx_5 zy_6)
         (let anf_77 (length anf_76)
          (let anf_78 (> anf_77 2.)
           (let anf_79 (> i_9 150.)
            (let anf_80 (|| anf_78 anf_79)
             (return
              (if anf_80 (return i_9)
               (let anf_81 (* zx_5 zx_5)
                (let anf_82 (* zy_6 zy_6)
                 (let anf_83 (- anf_81 anf_82)
                  (let next_zx_10 (+ anf_83 cx_7)
                   (let anf_84 (* 2. zx_5)
                    (let anf_85 (* anf_84 zy_6)
                     (let next_zy_11 (+ anf_85 cy_8)
                      (let anf_86 (+ i_9 1.)
                       (return (mandel_4 next_zx_10 next_zy_11 cx_7 cy_8 anf_86)))))))))))))))))))
      : (float -> (float -> (float -> (float -> (float -> float))))))
     ((Define Nonrec (name get_uv_0_vec2_to_vec2_75) (args ((coord_1 (vec 2))))
       (body
        (let anf_87 (* 2. coord_1)
         (let top_2 (- anf_87 u_resolution)
          (let anf_88 (index u_resolution 0)
           (let anf_89 (index u_resolution 1)
            (let bot_3 (min anf_88 anf_89) (return (/ top_2 bot_3)))))))))
      : ((vec 2) -> (vec 2)))
     ((Define Nonrec (name main) (args ((coord_12 (vec 2))))
       (body
        (let uv_13 (get_uv_0_vec2_to_vec2_75 coord_12)
         (let anf_90 (* u_time 0.4)
          (let anf_91 (sin anf_90)
           (let anf_92 (* anf_91 4.5)
            (let anf_93 (+ anf_92 3.5)
             (let zoom_14 (exp anf_93)
              (let anf_94 (index uv_13 0)
               (let anf_95 (/ anf_94 zoom_14)
                (let cx_15 (+ -0.7453 anf_95)
                 (let anf_96 (index uv_13 1)
                  (let anf_97 (/ anf_96 zoom_14)
                   (let cy_16 (+ 0.1127 anf_97)
                    (let iter_17 (mandel_4 0. 0. cx_15 cy_16 0.)
                     (let anf_98 (> iter_17 149.)
                      (return
                       (if anf_98 (return (vec3 0. 0. 0.))
                        (let n_18 (/ iter_17 150.)
                         (let anf_99 (vec3 10. 20. 30.)
                          (let anf_100 (* n_18 anf_99)
                           (let anf_101 (+ anf_100 u_time)
                            (let anf_102 (sin anf_101)
                             (let anf_103 (* anf_102 0.5)
                              (return (+ anf_103 0.5))))))))))))))))))))))))))
      : ((vec 2) -> (vec 3))))
                         ...
                         (set zx_5 next_zx_10
                          (set zy_6 next_zy_11
                           (set cx_7 cx_7
                            (set cy_8 cy_8
                             (set i_9 anf_86
                              (let _iter_inc_105 (+ _iter_104 1)
                               (set _iter_104 _iter_inc_105 continue))))))))))))))))))))))
          (return 0.)))))
      : (float -> (float -> (float -> (float -> (float -> float))))))
     ((Define (name get_uv_0_vec2_to_vec2_75) (args ((coord_1 (vec 2))))
       (body
        (let anf_87 (* 2. coord_1)
         (let top_2 (- anf_87 u_resolution)
          (let anf_88 (index u_resolution 0)
     ...
     ((Global Uniform (TyVec 2) u_resolution) (Global Uniform TyFloat u_time)
      (Function (name mandel_4) (desc ())
       ...
       (body
        ((set () int _iter_104 0)
         (while (< _iter_104 1000)
          (Block (set () vec2 anf_76 (vec2 zx_5 zy_6))
           (set () float anf_77 (length anf_76))
           (set () bool anf_78 (> anf_77 2.)) (set () bool anf_79 (> i_9 150.))
           (set () bool anf_80 (|| anf_78 anf_79))
           (if anf_80 (Block (return i_9))
            (Block (set () float anf_81 (* zx_5 zx_5))
             (set () float anf_82 (* zy_6 zy_6))
             (set () float anf_83 (- anf_81 anf_82))
             (set () float next_zx_10 (+ anf_83 cx_7))
             (set () float anf_84 (* 2. zx_5))
             (set () float anf_85 (* anf_84 zy_6))
             (set () float next_zy_11 (+ anf_85 cy_8))
             (set () float anf_86 (+ i_9 1.)) (set zx_5 next_zx_10)
             (set zy_6 next_zy_11) (set cx_7 cx_7) (set cy_8 cy_8)
             (set i_9 anf_86) (set () int _iter_inc_105 (+ _iter_104 1))
             (set _iter_104 _iter_inc_105) continue))))
         (return 0.))))
      (Function (name get_uv_0_vec2_to_vec2_75) (desc ())
       (params (((TyVec 2) coord_1))) (ret_type (TyVec 2))
       (body
        ((set () vec2 anf_87 (* 2. coord_1))
         (set () vec2 top_2 (- anf_87 u_resolution))
         (set () float anf_88 (index u_resolution 0))
         (set () float anf_89 (index u_resolution 1))
         (set () float bot_3 (min anf_88 anf_89)) (return (/ top_2 bot_3)))))
      (Function (name main) (desc ()) (params (((TyVec 2) coord_12)))
       (ret_type (TyVec 3))
       (body
        ((set () vec2 uv_13 (get_uv_0_vec2_to_vec2_75 coord_12))
         (set () float anf_90 (* u_time 0.4)) (set () float anf_91 (sin anf_90))
         (set () float anf_92 (* anf_91 4.5))
         (set () float anf_93 (+ anf_92 3.5)) (set () float zoom_14 (exp anf_93))
         (set () float anf_94 (index uv_13 0))
         (set () float anf_95 (/ anf_94 zoom_14))
         (set () float cx_15 (+ -0.7453 anf_95))
         (set () float anf_96 (index uv_13 1))
         (set () float anf_97 (/ anf_96 zoom_14))
         (set () float cy_16 (+ 0.1127 anf_97))
         (set () float iter_17 (mandel_4 0. 0. cx_15 cy_16 0.))
         (set () bool anf_98 (> iter_17 149.))
         (if anf_98 (Block (return (vec3 0. 0. 0.)))
          (Block (set () float n_18 (/ iter_17 150.))
           (set () vec3 anf_99 (vec3 10. 20. 30.))
           (set () vec3 anf_100 (* n_18 anf_99))
           (set () vec3 anf_101 (+ anf_100 u_time))
           (set () vec3 anf_102 (sin anf_101))
           (set () vec3 anf_103 (* anf_102 0.5)) (return (+ anf_103 0.5)))))))))
